...
function Home() {
  return (
    <div className="w-full h-full min-h-screen">
      <div className="max-w-screen-xl mx-auto px-6 pt-14 lg:px-8">
        ...
        <div className="mt-14 pb-6">
          <div className="mb-4 flex flex-wrap">
            <Select label="Select an animal" className="max-w-56" size="sm">
              {people.map((people, index) => (
                <SelectItem key={index}>{people.name}</SelectItem>
              ))}
            </Select>
          </div>
          ...
          <div className="mt-6 flex justify-center">
            <Pagination total={12} showControls loop />
          </div>
        </div>
      </div>
